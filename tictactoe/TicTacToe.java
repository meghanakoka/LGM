...
class TicTacToe {
    ...
    public static void game() {
        ...
        try {
             ...
             * System.out.println("\t Player 1 = X \t\t\t\t\t\t\t\t\t\t Player 1 Score = "
             * +score);
             * 
             * 
             * }
            ...
            if (arr[0][0] == "X" && arr[0][1] == "X" && arr[0][2] == "X") {
                ...
                /*
                 * System.out.
                 * println("Do You Want To Continue Then Press Y If No The Press Any Key");
                 * String yes = sc.next();
                 * if(yes == "Y" || yes == "y")
                 * {
                 * game();
    ...
    public static void main(String args[])
            throws IOException, InterruptedException, AWTException, IllegalMonitorStateException {
        Scanner sc = new Scanner(System.in);
        TicTacToe ge = null;
        ge.game();
        // ge.clearScreen();
